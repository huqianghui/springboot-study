...
/**
 * Copy from jackson ISO8601DateFormat,remove timezone information
 */
 ...
 *
 * @see ISO8601WithoutTimeZoneUtils
 */
public class ISO8601WithoutTimeZoneDateFormat extends DateFormat
{
    ...
    private Calendar calendarSun = new GregorianCalendar();
    private NumberFormat numberFormatSun = new DecimalFormat();

    public ISO8601WithoutTimeZoneDateFormat() {
        this.numberFormat = numberFormatSun;
        this.calendar = calendarSun;
    }
